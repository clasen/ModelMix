...
import { ModelMix, CustomOpenAIModel, CustomAnthropicModel, CustomPerplexityModel } from '../index.js';
...
mmix.attach(new CustomOpenAIModel({ config: { apiKey: env.OPENAI_API_KEY } }));
